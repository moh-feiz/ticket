...
<head>
    ...
    <?php $this->head() ?>
    <link type="text/css" rel="stylesheet" href="<?=Yii::getAlias('@web').'/layout/layout.css' ?>"/>
</head>
<body>
...
<div class="sidebar" data-color="purple" data-image="../assets/img/sidebar-1.jpg">
    ...
    <div class="sidebar-wrapper">
        <ul class="nav">
            ...
            <li>
                <a href="<?= Url::toRoute('stream/index') ?>">
                    <i class="material-icons text-gray">record_voice_over</i>
                    <p>STREAM</p>
                </a>
            </li>
